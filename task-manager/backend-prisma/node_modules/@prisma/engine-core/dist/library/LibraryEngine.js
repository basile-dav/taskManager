...
class LibraryEngine extends import_Engine.Engine {
  ...
  async transaction(action, headers, arg) {
    ...
    if (action === "start") {
      ...
      result = await ((_d = this.engine) == null ? void 0 : _d.commitTransaction(arg.id, headerStr));
    } else if (action === "rollback") {
      result = await ((_e = this.engine) == null ? void 0 : _e.rollbackTransaction(arg.id, headerStr));
    }
...
You may have to run ${import_chalk.default.greenBright("prisma generate")} for your changes to take effect.`,
    ...
    if (!this.engine) {
      ...
      try {
        ...
        this.engine = new this.QueryEngineConstructor(
          ...
          (log) => {
            var _a2;
            (_a2 = weakThis.deref()) == null ? void 0 : _a2.logger(log);
          }
        );
        engineInstanceCount++;
      } catch (_e) {
  ...
  async start() {
    ...
    const startFn = /* @__PURE__ */ __name(async () => {
      ...
      try {
        ...
        await ((_a = this.engine) == null ? void 0 : _a.connect(JSON.stringify(headers)));
  ...
  async stop() {
    ...
    const stopFn = /* @__PURE__ */ __name(async () => {
      ...
      await ((_a = this.engine) == null ? void 0 : _a.disconnect(JSON.stringify(headers)));
      this.libraryStarted = false;
    ...
    if (Array.isArray(batchResult)) {
      return batchResult.map((result2) => {
        ...
        if (result2.errors && result2.errors.length > 0) {
          return (_a = this.loggerRustPanic) != null ? _a : this.buildQueryError(result2.errors[0]);
        }
        return {
          data: result2,
          elapsed: 0
