...
export default function VectorTile({ name, active, before, url, style }) {
    if (url) {
        return /*#__PURE__*/ React.createElement(UrlVectorTile, {
            name: name,
            active: active,
            url: url,
            before: before
    ...
    return /*#__PURE__*/ React.createElement(
        ...
        Object.entries(sources).map(([id, source]) =>
            /*#__PURE__*/ React.createElement(AutoSource, {
                key: id,
                id: id,
                ...source
            })
        ...
        layers.map(layer =>
            /*#__PURE__*/ React.createElement(AutoLayer, {
                key: layer.id,
                active: active,
                before: before,
                ...layer
...
function UrlVectorTile({ name, active, before, url }) {
    ...
    if (style) {
        return /*#__PURE__*/ React.createElement(VectorTile, {
            name: name,
            active: active,
            before: before,
            style: style
