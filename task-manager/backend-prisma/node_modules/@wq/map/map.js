...
import reactRenderer from '@wq/react'; // module variable
...
const map = {
    ...
    config: {
        maps: {},
        // Auto-populated from app.config.pages where map == true
        bounds: [
            [-4, -4],
            [4, 4]
        ],
        autoZoom: {
            wait: 0.5,
            // How long to wait before triggering autoZoom
...
map.runComponent = 'OffscreenMaps'; // FIXME: Drop this function in 2.0
...
map.run = function ($page, routeInfo) {
    ...
    maps.forEach(mapname => {
        ...
        if (mode === 'edit') {
            ...
            Component = EmbeddedGeo.makeComponent({
                type,
                value,
                setValue
            });
        } else {
            Component = AutoMap.makeComponent({
                context
            });
        }
