...
export default function AutoInput({ name, choices, type, bind = {}, ...rest }) {
    ...
    if (type === 'group') {
        return /*#__PURE__*/ React.createElement(AutoSubform, {
            name: name,
            ...rest
        });
    } else if (type === 'repeat') {
        return /*#__PURE__*/ React.createElement(AutoSubformArray, {
            name: name,
            ...rest
        });
    }
    ...
    if (!Input) {
        return /*#__PURE__*/ React.createElement(
            ...
            'Unknown input type "',
            inputType,
            '". Perhaps you need to define inputs.',
            pascalCase(inputType),
            ' in a plugin?'
        );
    }
