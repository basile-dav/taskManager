...
function fieldToAutocomplete(_a) {
    var disabled = _a.disabled, field = _a.field, _b = _a.form, isSubmitting = _b.isSubmitting, setFieldValue = _b.setFieldValue, type = _a.type, onChange = _a.onChange, onBlur = _a.onBlur, freeSolo = _a.freeSolo, onInputChange = _a.onInputChange, props = __rest(_a, ["disabled", "field", "form", "type", "onChange", "onBlur", "freeSolo", "onInputChange"]);
    ...
    return __assign(__assign({ freeSolo: freeSolo, onBlur: onBlur !== null && onBlur !== void 0 ? onBlur : function (event) {
            ...
            : !freeSolo
                ...
                : undefined, disabled: disabled !== null && disabled !== void 0 ? disabled : isSubmitting, loading: isSubmitting }, fieldSubselection), props);
}
...
export { fieldToAutocomplete, Autocomplete, fieldToToggleButtonGroup, ToggleButtonGroup };
