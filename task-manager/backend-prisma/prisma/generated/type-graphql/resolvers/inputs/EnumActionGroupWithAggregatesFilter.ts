...
import { NestedEnumActionGroupWithAggregatesFilter } from "../inputs/NestedEnumActionGroupWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { ActionGroup } from "../../enums/ActionGroup";

@TypeGraphQL.InputType("EnumActionGroupWithAggregatesFilter", {
  isAbstract: true
})
export class EnumActionGroupWithAggregatesFilter {
