...
import { NestedEnumCommentTargetTypeWithAggregatesFilter } from "../inputs/NestedEnumCommentTargetTypeWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { CommentTargetType } from "../../enums/CommentTargetType";

@TypeGraphQL.InputType("EnumCommentTargetTypeWithAggregatesFilter", {
  isAbstract: true
})
export class EnumCommentTargetTypeWithAggregatesFilter {
